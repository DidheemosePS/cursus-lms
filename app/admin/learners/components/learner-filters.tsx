...
import type { LearnerCounts } from "@/dal/admin/learners.dal";
import { useDebounceCallback } from "@/hooks/use-debounce-callback";
import { InstructorCounts } from "@/dal/admin/instructors.dal";
...
export default function LearnerFilters({ counts }: { counts: LearnerCounts }) {
