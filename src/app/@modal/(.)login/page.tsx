...
export default function LoginPage() {
  ...
  return (
    <div
      className="w-full h-dvh fixed top-0 z-500 flex justify-center items-center bg-transparent"
      onClick={() => router.back()}
    >
      <main
        onClick={(e) => e.stopPropagation()}
        className="w-120 bg-white rounded-lg border border-gray-300 shadow-2xl flex flex-col items-center justify-center p-8"
      >
